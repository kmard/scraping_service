...
# jobs,error = work('https://www.work.ua/ru/jobs-python/')
# h = codecs.open('work.txt','w','utf-8')
# h.write(str(jobs))
# h.close()
# [print(*i.items(),sep='\n') for i in jobs]

# jobs,error = dou('https://jobs.dou.ua/vacancies/?category=Python')
# h = codecs.open('dou.txt','w','utf-8')
# h.write(str(jobs))
# h.close()
# [print(*i.items(),sep='\n') for i in jobs]

# jobs,error = rabota('https://rabota.ua/ua/zapros/python-programmer/%D1%83%D0%BA%D1%80%D0%B0%D0%B8%D0%BD%D0%B0')
...
jobs,error = djinni('https://djinni.co/jobs/keyword-python/')
